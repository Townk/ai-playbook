...
- [ ] Inline agent `ask` is unavailable off-mux (the inline TUI owns the terminal); a richer version could suspend/release bubbletea (`tea.ReleaseTerminal`/`RestoreTerminal`) to prompt inline (2026-06-27)
